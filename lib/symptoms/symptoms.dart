...
//Screen für Fragebögen -> Hier wird die Navigation zu den beiden Fragebögen angezeigt
    ...
    return Scaffold(
      ...
      body: ListView(children: <Widget>[
              ...
              child: InkWell(
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              WeeklyQuestSymptoms()) //Bei Klick gelangen zu Fragebogen
                      );
                },
                child: ListTile(
                  title: Text(
                  ...
                  subtitle: Text(
                    "Bitte machen Sie in diesem Fragebogen einmal alle 2 Wochen Angaben zu Ihren Symptomen!",
                  ),
                ),
              ),
            ))),
              ...
              child: InkWell(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => WeeklyQuestHealth(),
                        )); //Bei Klick gelangen zu Fragebogen
                  },
                  child: ListTile(
                    title: Text(
                      "Gesundheit",
                    ...
                    subtitle: Text(
                      "Bitte machen Sie in diesem Fragebogen einmal alle 2 Wochen Angaben zu Ihrer psychischen Gesundheit!",
                    ),
                  )),
            ),
          ),
        ...
        Container(
          ...
          child: Image.asset('assets/Doktor.PNG', fit: BoxFit.contain),
        ),
      ]),
    );
  }
