...
//Erstellen des Knopfes für die Umfragen
//-> mit callback Funktion um die Ergebnisse während der Umfarge kurz zu speichern und die Frabe zu ändern (grün wenn ausgewählt und weiß wenn nicht ausgewählt)
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: RaisedButton(
          ...
          color: (widget.text == widget.currentValue)
