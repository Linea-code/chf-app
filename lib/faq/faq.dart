        ...
        body: Container(
          ...
          child: ListView(children: <Widget>[
            Container(
              ...
              child: Image.asset('assets/Arzt&Pflegerin.png'), //Titelbild mit Ärztin und Arzt
            ),
            Container(
              padding: EdgeInsets.all(10.0),
              child: Text(
            ...
            //Zudem unterteilung der Fragen in spezifische Gruppen, um eine bessere Struktur zu ermöglichen

            Card(
              color: Color(0xfff0fcfc),
              child: ExpansionTile(
                title: Text("Was genau ist chronische Herzinsuffizienz?"),
                children: <Widget>[
                  Container(
                    child: Column(children: <Widget>[
                      Image.asset(
                          "assets/Herzinsuffizienz_Abb.jpg"), //Bild aus dem Ordner Assets
                      Text(
              ...
              child: ExpansionTile(
                ...
                children: <Widget>[
                  Container(
                    child: Column(children: <Widget>[
                      Image.asset(
                          "assets/Blutdruck_messen.png"), //Bild aus dem Ordner assets
                      Text(
            ...
            Card(
              color: Color(0xfff0fcfc),
              child: ExpansionTile(
                title: Text("Wie kann man Atemnot vorbeugen?"),
                children: <Widget>[
                  Container(
                    padding: EdgeInsets.all(10.0),
                    child: Text(
            ...
            Card(
              color: Color(0xfff0fcfc),
              child: ExpansionTile(
                title: Text("Wie kann man Schwindel vorbeugen?"),
                children: <Widget>[
                  Container(
                    padding: EdgeInsets.all(10.0),
                    child: Text(
            ...
            Card(
              color: Color(0xfff0fcfc),
              child: ExpansionTile(
                title: Text("Wie kann man Schwellungen vorbeugen?"),
                children: <Widget>[
                  Container(
                    padding: EdgeInsets.all(10.0),
                    child: Text(
                        ...
                        "Zudem sollten Sie Genussmittel wie Alkohol und Zigaretten meiden. Außerdem müssen Sie sich an die von Ihrem Arzt vorgeschriebene Trinkmenge halten und Ihre "
            ...
            Card(
              color: Color(0xfff0fcfc),
              child: ExpansionTile(
                title: Text("An wen wende ich mich bei einem Notfall?"),
                children: <Widget>[
                  Container(
                    padding: EdgeInsets.all(10.0),
                    child: Text(
            ...
            Card(
              color: Color(0xfff0fcfc),
              child: ExpansionTile(
                title: Text("Wie kann ich mich auf einen Notfall vorbereiten?"),
                children: <Widget>[
                  Container(
                    padding: EdgeInsets.all(10.0),
                    child: Text(
                        ...
                        "Tragen Sie beispielsweise grundätzlich Ihr Smartphone bei sich. Lassen Sie sich außerdem von Ihrem behandelnden Arzt Hinweise zum Umgang mit aktuten Krankheitsverschlechterungen geben."),
                  )
                ],
              ),
            ),
