...
// Anlage der eigenen Klasse um Medikationsangaben zu speichern mit Deklaration der Variablen:
class SaveMedications {
  ...
  static Future<SaveMedications> loadData() async {
    ...
    if (prefs.containsKey('checkMorning') &&
      ...
      if (DateTime.now()
              .difference(DateTime.fromMillisecondsSinceEpoch(data.lastDate))
              .inDays ==
          0) {
