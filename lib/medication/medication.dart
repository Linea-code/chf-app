...
class _MedicationState extends State<Medication> {
  //Prinzipiell können die folgenden Listen zu einem späteren Zeintpunkt aus einer Datenbank gewonnen werden, welche direkt mit dem Arzt verknüpft ist und somit kontinuierlich angepasst werden kann
  // Anlage der Listen für Medikation: Morgens, Mittags, Abends, Nachts
  var medMorning = [
    "1 Tabl. Metoproiolsuccinat (95 mg)",
    "1 Tabl. Ramipril (5 mg)",
    "1 Tabl. Pantoprazol (20 mg)"
  ];
  ...
  // Anlage der Boolschen Variablen für das Abhaken der Medikationseinnahme -> Initialisierung mit false
  var medicationState;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          (medicationState != null && medicationState.feeling != null)
              ? SizedBox()
              : Card(
                  child: ListTile(
          ...
          Card(
              color: (medicationState != null && medicationState.checkMorning)
                  ? Colors.grey[200]
                  : Color(0xfff0fcfc),
              child: CheckboxListTile(
                ...
                value: (medicationState == null
                    ? false
                    : medicationState.checkMorning),
          ...
          //nach Einnahme verschwieden sollen -> Aufgrund von vermutlichen Usability Problemen, da ältere Menschen versehentlich auf den Knopf drücken können
          // und dann ihre Medikation nicht mehr sehen und es so zu falschen Angaben beim Arzt kommen kann, wurde dieser Abschnitt hier auskommentiert
          Card(
            color: (medicationState != null && medicationState.checkDay)
                ? Colors.grey[200]
                : Color(0xfff0fcfc),
            child: CheckboxListTile(
              title: Text("Mittags"),
              ...
              activeColor: Colors.lightGreen[500],
              value:
                  (medicationState == null ? false : medicationState.checkDay),
              onChanged: (bool value) {
                setState(() {
          ...
          // und dann ihre Medikation nicht mehr sehen und es so zu falschen Angaben beim Arzt kommen kann, wurde dieser Abschnitt hier auskommentiert
          Card(
            color: (medicationState != null && medicationState.checkEvening)
                ? Colors.grey[200]
                : Color(0xfff0fcfc),
            child: CheckboxListTile(
              title: Text("Abends"),
          ...
          // und dann ihre Medikation nicht mehr sehen und es so zu falschen Angaben beim Arzt kommen kann, wurde dieser Abschnitt hier auskommentiert
          Card(
            color: (medicationState != null && medicationState.checkNight)
                ? Colors.grey[200]
                : Color(0xfff0fcfc),
            child: CheckboxListTile(
              title: Text("Nachts"),
