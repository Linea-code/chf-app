...
// Profil Screen mit Anzeige der Stammdaten
  ...
  Widget build(BuildContext context) {
    return profile != null
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        CircleAvatar( //Später könnte hier ein Profilbild o.ä. integriert werden
                          radius: 50,
                ...
                Container(
                  ...
                  child: Text("Vorname: ${profile.firstName} "),
                ),
                Container(
                  padding: EdgeInsets.all(15),
                  child: Text("Nachname: ${profile.secondName}"),
                ),
                Container(
                  padding: EdgeInsets.all(15),
                  child: Text("Geschlecht: ${profile.gender} "),
                ),
                Container(
                  padding: EdgeInsets.all(15),
                  child: Text(
                      "Geburtsdatum: ${profile.birthdate.day}.${profile.birthdate.month}.${profile.birthdate.year} "),
                ),
                Container(
                  padding: EdgeInsets.all(15),
                  child: Text("Lebensumstände: ${profile.livingConditions} "),
                ),
                Container(
                  padding: EdgeInsets.all(15),
                  child: Text(
                ...
                Container(
                  padding: EdgeInsets.all(15),
                  child: Text("Begleiterkrankungen: ${profile.comorbidities} "),
                ),
                Container(
        ...
        : Scaffold(
            ...
            //Ladescreen, falls keine Daten vorhanden sind
