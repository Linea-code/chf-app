            ...
            child: Padding(
              ...
              child: ListView(children: <Widget>[
                ...
                Card(
                  child:
                  ExpansionTile(
                    title: Text(("Durchschnittliches Gewicht des letzten Monats: " + (avrWeight.toStringAsFixed(2))),
                      style: TextStyle(
                        fontSize: 18.0,
                      ),),
                    children: <Widget>[
                      Container(
                        ...
                        child:
                        Text("Ihr durchschnittliches Gewicht setzt sich aus allen Messwerten des vergangen Monats zusammen. Sollten Sie starke Gewichtsveränderungen feststellen kontaktieren Sie bitte Ihren Arzt.",
                          style: TextStyle(
                            fontSize: 16.0,
                          ),),
                      ),],
